use crate::daemon::scanners::projects::framework_macro::FrameworkHeuristics;
use crate::daemon::scanners::projects::framework_macro::frameworks;
...
frameworks! {
    ...
    Rails {
        ...
        custom: |project_path: &str| {
            use crate::daemon::scanners::projects::framework_macro::has_file;
